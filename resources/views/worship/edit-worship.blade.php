...
<script>
   <script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        let addedMembers = {!! $worship->members->pluck('id') !!}; // Array to hold added member IDs
        ...
        function createMemberListItem(memberId, memberName) {
            ...
            removeButton.addEventListener('click', function () {
                listItem.remove();
                removeMemberPosition(memberId); // Remove corresponding position input
        ...
        function removeMemberPosition(memberId) {
